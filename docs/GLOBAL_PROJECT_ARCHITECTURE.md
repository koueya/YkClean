...
├── migrations/
│   ├── Version*.php
│   └── Version20240201CreateQuoteItems.php   # ← NOUVEAU - Migration pour la table quote_items
│
├── public/
│   └── index.php
│
...
│   │   │
│   │   ├── Service/
│   │   │   ├── ServiceRequest.php           # ✅ MODIFIÉ - Ajout subcategory_id
│   │   │   ├── ServiceCategory.php          # ✅ MODIFIÉ - Ajout hiérarchie parent/children
│   │   │   ├── ServiceSubcategory.php       # ✅ NOUVEAU - Sous-catégories détaillées
│   │   │   └── ServiceType.php              # ⚠️ DEPRECATED - À supprimer (remplacé par ServiceSubcategory)
│   │   │
│   │   ├── Quote/
│   │   │   ├── Quote.php                     # ← Modifié (relation OneToMany vers QuoteItem)
│   │   │   ├── QuoteItem.php                 # ← NOUVEAU - Ligne détaillée d'un devis
│   │   │   └── QuoteStatus.php
│   │   │
│   │   ├── Booking/
│   │   │   ├── Booking.php
...
│   │   │   ├── ServiceCategoryRepository.php     # ✅ MODIFIÉ - Méthodes hiérarchie
│   │   │   ├── ServiceSubcategoryRepository.php  # ✅ NOUVEAU
│   │   │   └── ServiceTypeRepository.php         # ⚠️ DEPRECATED
│   │   │
│   │   ├── Quote/
│   │   │   ├── QuoteRepository.php
│   │   │   └── QuoteItemRepository.php       # ← NOUVEAU - Repository pour QuoteItem
│   │   │
│   │   ├── Booking/
...
│   │   │   ├── ScheduleService.php           # ← Service (pas d'entité Schedule)
...
│   │   │
│   │   ├── Matching/
│   │   │   └── MatchingService.php              # ✅ MODIFIÉ - Utilise subcategories
│   │   │
│   │   ├── Category/                            # ✅ NOUVEAU - Services catégories
│   │   │   ├── CategoryService.php
...
│   │   │   │   ├── ServiceRequestController.php     # ✅ MODIFIÉ - Filtre par spécialisations
│   │   │   │   ├── SpecializationController.php     # ✅ NOUVEAU - Gestion spécialisations
│   │   │   │   ├── QuoteController.php
│   │   │   │   ├── BookingController.php
...
│   │   │   │   ├── CategoryController.php        # ✅ NOUVEAU - Gestion catégories
│   │   │   │   ├── SubcategoryController.php     # ✅ NOUVEAU - Gestion sous-catégories
│   │   │   │   ├── BookingManagementController.php
│   │   │   │   └── StatisticsController.php
│   │   │   │
│   │   │   └── Common/
│   │   │       ├── CategoryController.php        # ✅ NOUVEAU - API publique catégories
...
│   │   │   │
│   │   │   ├── ServiceRequest/
│   │   │   │   ├── ServiceRequestForm.jsx        # ✅ MODIFIÉ - Utilise sous-catégories
│   │   │   │   ├── ServiceRequestList.jsx
│   │   │   │   ├── ServiceRequestCard.jsx
│   │   │   │   ├── ServiceCategorySelector.jsx   # ✅ MODIFIÉ - Navigation hiérarchique
│   │   │   │   ├── CategoryPicker.jsx            # ✅ NOUVEAU - Sélection catégorie
│   │   │   │   └── SubcategoryPicker.jsx         # ✅ NOUVEAU - Sélection sous-catégorie
│   │   │   │
│   │   │   ├── Quote/
│   │   │   │   ├── QuoteList.jsx
│   │   │   │   ├── QuoteCard.jsx
...
│   │   │       ├── EditProfile.jsx
│   │   │       ├── DocumentUpload.jsx
│   │   │       ├── ServiceCategories.jsx         # ⚠️ DEPRECATED
│   │   │       ├── SpecializationManager.jsx     # ✅ NOUVEAU - Gestion spécialisations
│   │   │       └── ZoneSettings.jsx
│   │   │
│   │   └── admin/
│   │       ├── Dashboard/
...
│   │       │
│   │       ├── ServiceCategories/
│   │       │   ├── CategoryList.jsx          # ✅ MODIFIÉ - Affichage hiérarchique
│   │       │   ├── CategoryTree.jsx          # ✅ NOUVEAU - Arborescence
│   │       │   ├── CategoryForm.jsx
│   │       │   ├── CategoryCard.jsx
│   │       │   ├── SubcategoryList.jsx       # ✅ NOUVEAU
│   │       │   ├── SubcategoryForm.jsx       # ✅ NOUVEAU
│   │       │   └── SubcategoryCard.jsx       # ✅ NOUVEAU
│   │       │
...
│   │   │   ├── categorySlice.js              # ✅ NOUVEAU - Store catégories
│   │   │   ├── subcategorySlice.js           # ✅ NOUVEAU - Store sous-catégories
...
│   │   ├── useCategories.js              # ✅ NOUVEAU - Hook catégories
│   │   ├── useSubcategories.js           # ✅ NOUVEAU - Hook sous-catégories
...
│   │   ├── CategoryService.js            # ✅ NOUVEAU - Service catégories
│   │   ├── SubcategoryService.js         # ✅ NOUVEAU - Service sous-catégories
...
## 📝 Notes Importantes sur l'Architecture

### QuoteItem - Devis Détaillés

**QuoteItem** est une **nouvelle entité** ajoutée pour permettre des devis professionnels ligne par ligne :

```
Quote (Devis principal)
  ├─ amount: 85.00€ (calculé automatiquement)
  └─ items: Collection<QuoteItem>
      ├─ QuoteItem #1: "Cuisine" - 30.00€
      ├─ QuoteItem #2: "Salle de bain" - 25.00€
      └─ QuoteItem #3: "3 chambres" - 30.00€
```

**Avantages** :
- ✅ Transparence totale pour le client
- ✅ Modification facile d'une ligne sans refaire tout le devis
- ✅ Calcul automatique du montant total
- ✅ Prestations optionnelles (le client peut refuser certaines lignes)
- ✅ Format professionnel (comme une facture détaillée)

**Fichiers concernés** :
- `/Entity/Quote/QuoteItem.php` - Nouvelle entité
- `/Entity/Quote/Quote.php` - Modifié (relation OneToMany)
- `/Repository/Quote/QuoteItemRepository.php` - Nouveau repository
- `/migrations/Version20240201CreateQuoteItems.php` - Migration

---

### Schedule - Service vs Entité

**Important** : `Schedule` n'est **PAS une entité** en base de données.

**Schedule** est un **service** qui calcule et agrège dynamiquement :
- Les disponibilités (`Availability`)
- Les réservations (`Booking`)
- Les absences (`Absence`)

```
ScheduleService.getWeeklySchedule() {
  → Récupère Availability (créneaux disponibles)
  → Récupère Booking (créneaux réservés)
  → Récupère Absence (créneaux indisponibles)
  → Calcule et retourne le planning complet
}
```

**Raison** : Le planning est une **vue calculée**, pas des données persistées. Il change constamment en fonction des réservations et disponibilités.

---

### 🆕 Catégories et Sous-catégories - Système Hiérarchique

**Nouvelles entités ajoutées** pour une gestion complète des services :

#### ServiceCategory (Modifié)

Désormais supporte une **hiérarchie multi-niveaux** via auto-référence :

```php
ServiceCategory {
  id: int
  name: string                    // Ex: "Nettoyage", "Entretien courant"
  slug: string                    // Ex: "nettoyage", "entretien-courant"
  parent: ?ServiceCategory        // ✅ NOUVEAU - Auto-référence
  children: Collection            // ✅ NOUVEAU - Catégories enfants
  subcategories: Collection       // Sous-catégories terminales
  isActive: bool
  displayOrder: int
}
```
...
Niveau terminal de la hiérarchie avec détails spécifiques :

```php
ServiceSubcategory {
  id: int
  category: ServiceCategory       // Catégorie parente
  name: string                    // Ex: "Grand ménage classique"
  slug: string
  description: text
  basePrice: decimal              // Tarif de base (€/h)
  estimatedDuration: int          // Durée estimée (minutes)
  icon: string
  requirements: json              // Ex: ["aspirateur", "produits pro"]
  isActive: bool
  displayOrder: int
}
```
...
Grand ménage avec vitres
├── basePrice: 35€/h
├── estimatedDuration: 360 min
└── requirements: ["matériel complet", "kit vitres"]

Nettoyage après travaux
├── basePrice: 40€/h
├── estimatedDuration: 480 min
└── requirements: ["matériel professionnel", "aspirateur eau et poussière"]
```

#### ServiceRequest (✅ MODIFIÉ)

Inclut maintenant la sous-catégorie :

```php
ServiceRequest {
  // ... champs existants ...
  category: ServiceCategory       // Catégorie principale
  subcategory: ServiceSubcategory // ✅ NOUVEAU - Sous-catégorie spécifique
  surfaceArea: int               // ✅ NOUVEAU - m² (pour nettoyage)
  specificRequirements: json     // ✅ NOUVEAU - Détails (fenêtres, four, etc.)
}
```

#### Prestataire (✅ MODIFIÉ)

Gère ses spécialisations :

```php
Prestataire {
  // ... champs existants ...
  specializations: Collection<ServiceSubcategory>  // ✅ NOUVEAU - ManyToMany
}
```
...
└── Spécialisations:
    ├── Nettoyage standard (25€/h)
    ├── Grand ménage classique (30€/h)
    └── Nettoyage de fin de bail (45€/h)
```

#### Algorithme de Matching Amélioré

Le matching utilise maintenant les **sous-catégories** :

```php
MatchingService::findMatchingPrestataires(ServiceRequest $request) {
  
  // 1. Filtrage par spécialisation EXACTE
  WHERE prestataire.specializations CONTAINS request.subcategory
  
  // 2. Filtrage géographique
  AND distance(prestataire.location, request.location) <= prestataire.radius
  
  // 3. Filtrage disponibilité
  AND prestataire IS AVAILABLE ON request.preferredDate
...
├── Spécialisation exacte: 40 pts
├── Distance: 30 pts (inversement proportionnel)
├── Note moyenne: 20 pts
...
**Côté Client** :
```
1. Accède à /api/categories/tree
   → Affiche arborescence complète

2. Sélectionne "Nettoyage" > "Grand ménage"
   
3. GET /api/categories/{id}/subcategories
   → Affiche sous-catégories disponibles

4. Choisit "Grand ménage classique"
   → Affiche: basePrice (30€/h), duration (4-6h), requirements

5. Remplit formulaire avec détails:
   - surfaceArea: 80m²
   - specificRequirements: ["fenêtres", "four"]
   
6. POST /api/client/service-requests {
     category_id: 2,
     subcategory_id: 5,
     surfaceArea: 80,
     ...
...
7. Système notifie uniquement prestataires spécialisés
```

**Côté Prestataire** :
```
1. Configure son profil
   
2. GET /api/categories/tree
   → Voit toutes catégories/sous-catégories

3. PUT /api/prestataire/specializations {
     specializations: [
       { subcategory_id: 5, hourly_rate: 30 },
       { subcategory_id: 8, hourly_rate: 35 },
       { subcategory_id: 12, hourly_rate: 40 }
     ]
   }

4. Reçoit SEULEMENT les demandes correspondant à ses spécialisations

5. Crée devis détaillé avec QuoteItem basé sur sous-catégorie
```
...
**Public** :
```
GET    /api/categories                       # Catégories racines
GET    /api/categories/tree                  # Arborescence complète
GET    /api/categories/{id}                  # Détails catégorie
GET    /api/categories/{id}/children         # Enfants directs
GET    /api/categories/{id}/subcategories    # Sous-catégories
GET    /api/subcategories/{id}               # Détails sous-catégorie
GET    /api/subcategories/{id}/pricing       # Tarifs moyens
```
...
PUT    /api/admin/categories/reorder         # Réorganiser
POST   /api/admin/subcategories              # Créer sous-catégorie
PUT    /api/admin/subcategories/{id}         # Modifier sous-catégorie
DELETE /api/admin/subcategories/{id}         # Supprimer sous-catégorie
```

**Prestataire** :
```
GET    /api/prestataire/specializations      # Mes spécialisations
PUT    /api/prestataire/specializations      # Mettre à jour
POST   /api/prestataire/specializations/{subcategoryId}    # Ajouter
DELETE /api/prestataire/specializations/{subcategoryId}    # Retirer
```

#### Composants Frontend

**Web (React)** :
- `CategoryPicker.jsx` - Sélection catégorie avec navigation
- `SubcategoryPicker.jsx` - Sélection sous-catégorie
- `CategoryTree.jsx` - Affichage arborescence admin
- `SpecializationManager.jsx` - Gestion spécialisations prestataire

**Mobile (React Native)** :
- `CategoryPicker.js` - Écran sélection catégorie
- `SubcategoryPicker.js` - Écran sélection sous-catégorie
- `SpecializationsScreen.js` - Écran gestion spécialisations

#### Avantages du Système

✅ **Tarification précise** - Chaque sous-catégorie a son tarif  
✅ **Matching intelligent** - Prestataires reçoivent demandes pertinentes  
✅ **Évolutivité** - Facile d'ajouter de nouvelles sous-catégories  
✅ **Expérience utilisateur** - Navigation intuitive par catégories  
✅ **Professionnalisme** - Devis détaillés et précis  
✅ **Performance** - Cache sur arborescence (Redis)  

#### Fichiers Concernés

**Backend** :
- `/Entity/Service/ServiceCategory.php` - ✅ MODIFIÉ
- `/Entity/Service/ServiceSubcategory.php` - ✅ NOUVEAU
- `/Entity/Service/ServiceRequest.php` - ✅ MODIFIÉ
- `/Entity/User/Prestataire.php` - ✅ MODIFIÉ
- `/Repository/Service/ServiceCategoryRepository.php` - ✅ MODIFIÉ
- `/Repository/Service/ServiceSubcategoryRepository.php` - ✅ NOUVEAU
- `/Service/Category/CategoryService.php` - ✅ NOUVEAU
- `/Service/Category/SubcategoryService.php` - ✅ NOUVEAU
- `/Service/Matching/MatchingService.php` - ✅ MODIFIÉ
- `/Controller/Api/Admin/CategoryController.php` - ✅ NOUVEAU
- `/Controller/Api/Admin/SubcategoryController.php` - ✅ NOUVEAU
- `/Controller/Api/Common/CategoryController.php` - ✅ NOUVEAU
- `/Controller/Api/Prestataire/SpecializationController.php` - ✅ NOUVEAU
- `/migrations/VersionXXXX_CreateSubcategories.php` - ✅ NOUVEAU

**Frontend** :
- `components/client/CategoryPicker.jsx` - ✅ NOUVEAU
- `components/client/SubcategoryPicker.jsx` - ✅ NOUVEAU
- `components/prestataire/SpecializationManager.jsx` - ✅ NOUVEAU
- `components/admin/CategoryTree.jsx` - ✅ NOUVEAU
- `slices/categorySlice.js` - ✅ NOUVEAU
- `slices/subcategorySlice.js` - ✅ NOUVEAU
- `hooks/useCategories.js` - ✅ NOUVEAU
- `services/CategoryService.js` - ✅ NOUVEAU
...
3. **Système de catégorisation hiérarchique et flexible**
4. **Matching intelligent basé sur les spécialisations**
5. **Pattern CQRS pour les opérations complexes**
6. **Event-driven architecture pour la communication**
7. **API RESTful bien structurée**
8. **Support mobile natif (React Native)**
...
2. ✅ **QuoteItem ajouté** (devis détaillés)
3. ✅ **Système de catégories/sous-catégories** (hiérarchie complète)
4. 🔄 **Créer les entités principales**
5. 🔄 **Implémenter le module Financial**
6. 🔄 **Créer les migrations pour catégories et sous-catégories**
7. 🔄 **Développer les services de catégorisation**
8. 🔄 **Implémenter l'algorithme de matching amélioré**
9. 🔄 **Créer les controllers et API**
10. 🔄 **Implémenter l'authentification JWT**
11. 🔄 **Développer l'application mobile et web**
